  ...
  public Display() {
    ...
    btnDrawWeightedShortest.addMouseListener(new MouseAdapter() {
      ...
      public void mouseReleased(MouseEvent e) {
        ...
        if(startCity == endCity){//does not allow Same Start and End Cities
        	System.out.println("You have entered the same start and end cities, please change either to be different");
        	System.out.println("Current Distance is 0");
        	System.exit(0);
        }
