...
public class Vertex implements Comparable <Vertex> {//modified vertex to be comparable, so as to compare vertexes
...
@Override
public int compareTo(Vertex o) {//overriden compareable method
	// TODO Auto-generated method stub
	 double distance = this.distance - o.distance;
	 return (int) distance;
}
